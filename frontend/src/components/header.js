...
<div class="search">
  <form class="search-form"  id="search-form">
    ...
    <button type="submit"><i class="fa fa-search"></i></button>
            ...
            <div>
            ${name ?`<a href="#/profile">${name}</a>`:`<a href="#/signin"><i class='bx bxs-user-circle' ></i>Sign-In</a>`}
                
                <a href="#/cart"><i class='bx bxs-cart-alt bx-tada'></i>Cart</a>
